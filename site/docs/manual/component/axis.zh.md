...
坐标轴（Axis）配置项用于自定义坐标轴的显示样式与交互效果，包括标题、刻度、网格线等元素。

| 属性     | 描述                           | 类型              | 默认值          | 必选 |
| -------- | ------------------------------ | ----------------- | --------------- | ---- |
| title    | 设置坐标轴的标题文本及其样式   | [title](#轴标题)  | [详见](#轴标题) |      |
| line     | 设置坐标轴线的显示及其样式     | [line](#轴线)     | [详见](#轴线)   |      |
| tickLine | 设置坐标轴刻度线的显示及其样式 | [tickLine](#刻度) | [详见](#刻度)   |      |
| label    | 设置坐标轴刻度值的显示及其样式 | [label](#刻度值)  | [详见](#刻度值) |      |
| grid     | 设置坐标轴网格线的显示及其样式 | [grid](#网格线)   | [详见](#网格线) |      |
| animate  | 设置坐标轴动画效果             | [animate](#动画)  | [详见](#动画)   |      |
